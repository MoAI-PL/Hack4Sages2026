...
* **Phase inventory tracking:**
    * **Liquid:** Maintained within the “habitable zone” ($0^\circ\text{C} < T < 100^\circ\text{C}$).
...
This project is open‑source and available under the [MIT License](LICENSE). Feel free to use, modify, and extend it, with attribution.
